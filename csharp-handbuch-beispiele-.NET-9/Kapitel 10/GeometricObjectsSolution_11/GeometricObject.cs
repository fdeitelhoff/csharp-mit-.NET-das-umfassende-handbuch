...
{
    public abstract class GeometricObject : IComparable, IComparable<GeometricObject>, INotifyPropertyChanged
    {
        #region Felder
        ...
        {
            if (geo1 is GeometricObject && geo2 is GeometricObject)
            {
        ...
        public static bool operator >(GeometricObject geo1, GeometricObject geo2)
            => geo1.GetArea() > geo2.GetArea() ? true : false;
